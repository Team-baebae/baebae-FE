...
const TutorialFeedList = () => {
  const data = [
    { id: 1, questionContent: '안녕', nickname: '유자인' },
    { id: 2, questionContent: '안녕', nickname: '유자인' },
    { id: 3, questionContent: '안녕', nickname: '유자인' },
    { id: 4, questionContent: '안녕', nickname: '유자인' },
    { id: 5, questionContent: '안녕', nickname: '유자인' },
    { id: 6, questionContent: '안녕', nickname: '유자인' },
  ]
